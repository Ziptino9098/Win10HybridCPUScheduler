...
// ----------------------------------------------------------------
//  Timer DPC: fires every 500ms, signals worker thread
// ----------------------------------------------------------------
